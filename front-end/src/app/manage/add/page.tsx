  ...
  return (
    <Box sx={{ backgroundColor: "#F7F7F7", paddingX: { xs: 2, md: 12 }, py: 4 }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', mb: 2, gap: 2 }}>
        <Box sx={{ flex: 1 }} />
        <Button onClick={() => handleReNew()} sx={{ backgroundColor: '#FFCC70', color: 'black', width: '180px', px: 2, borderRadius: 2, display: 'flex', alignItems: 'center' }}> Làm mới </Button>
        <Button onClick={() => handleSubmit()} sx={{ backgroundColor: '#4C3BCF', color: 'white', width: '180px', px: 2, borderRadius: 2, display: 'flex', alignItems: 'center' }}> Thêm sản phẩm </Button>
      </Box>
