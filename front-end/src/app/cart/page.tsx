...
function Cart() {
  ...
  return (
    <Box sx={{ backgroundColor: "#F7F7F7", padding: 4, px: 16 }}>
        ...
        <Box sx={{ width: '70%', my: 2 }}>
          <Box sx={{ backgroundColor: 'white', px: 2, borderTopLeftRadius: '20px', borderTopRightRadius: '20px', borderBottom: "3px solid #F7F7F7", display: 'flex', alignItems: 'center', gap: 4 }}>
            ...
            <Box sx={{ width: '50%', display: 'flex' }}>
              <Typography sx={{ textAlign: 'center', width: '30%' }}> Giá thành </Typography>
              <Typography sx={{ textAlign: 'center', width: '30%' }}> Số lượng </Typography>
              <Typography sx={{ textAlign: 'center', width: '25%' }}> Đơn vị </Typography>
              <Box sx={{ width: '15%' }} />
            </Box>
          </Box>
          ...
          <Box sx={{ backgroundColor: 'white', px: 2, borderBottomLeftRadius: '20px', borderBottomRightRadius: '20px', borderBottom: "3px solid #F7F7F7" }}>
            {cartItems.map((item) => (
              <Box key={item.id} sx={{ display: 'flex', alignItems: 'center', gap: 4, py: 2 }}>
                ...
                <Box sx={{ width: '50%', display: 'flex', alignItems: 'center', }}>
                  <Typography sx={{ textAlign: 'center', color: '#003092', width: '30%' }}> {calculatePrice(item.product.price, item.quantity)} đ</Typography>
                  ...
                  <Box sx={{ width: '30%', display: "flex", alignItems: "center", justifyContent: 'center' }}>
                    ...
                    <TextField
                      ...
                      sx={{
                        ...
                        "& .MuiInputBase-input": {
                          padding: "0px", // Xóa padding thừa trong input
                          textAlign: "center",
                        },
                      }}
                      size="small"
                  ...
                  <Typography sx={{ textAlign: 'center', width: '25%' }}> {item.product.unit} </Typography>
